...
public class HyphenatedCourseInformationTest {
    ...
    public void hyphenatedCourseInformationParsing_isCorrect() throws Exception {
        ...
        FocusPageParser.HyphenatedCourseInformation expectedCourse1 =
                new FocusPageParser.HyphenatedCourseInformation("Physical Education", "1", true, "H", "Red", "Clive Alston");
        ...
        FocusPageParser.HyphenatedCourseInformation expectedCourse2 =
                new FocusPageParser.HyphenatedCourseInformation("Language Arts", null, false, "MWF", "Red", "Ella Barron");
        ...
        FocusPageParser.HyphenatedCourseInformation expectedCourse3 =
                new FocusPageParser.HyphenatedCourseInformation(null, null, false, "MWF", "Red", "Ella Barron");
        ...
        FocusPageParser.HyphenatedCourseInformation expectedCourse4 =
                new FocusPageParser.HyphenatedCourseInformation(null, null, false, "MWF", "Red", "Ella van-Barron");
        ...
        FocusPageParser.HyphenatedCourseInformation expectedCourse5 =
                new FocusPageParser.HyphenatedCourseInformation(null, "Advisory", false, "M", "Red", "Ella Barron");
        ...
        FocusPageParser.HyphenatedCourseInformation expectedCourse6 =
                new FocusPageParser.HyphenatedCourseInformation("Senior Project", "Advisory", false, "W", "001", "Amarah Travis");
        ...
        FocusPageParser.HyphenatedCourseInformation expectedCourse7 =
                new FocusPageParser.HyphenatedCourseInformation(null, "Advisory", false, null, "12", "Shayna Hollis");
