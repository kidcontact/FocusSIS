...
public class SettingsFragment extends PreferenceFragmentCompat implements PageFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        changeGoogleAccount = getPreferenceManager().findPreference(getString(R.string.key_change_google_account));
        if (getActivity() != null) {
        ...
        Preference clearSavedAssignments = getPreferenceManager().findPreference(getString(R.string.key_clear_all_saved_assignments));
