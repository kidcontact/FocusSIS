...
public class CourseFragment extends NetworkFragment {
    ...
    private void editAssignment(final CourseAssignment assignment, final boolean descOnly) {
        ...
        if (assignment != null) {
            ...
            String rememberedCategory = preferencesHelper.getAssignmentMenuCategoryForCourse(course.getId());
            ...
            public void run() {
                spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                    ...
                    public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                        ...
                        preferencesHelper.setAssignmentMenuCategoryForCourse(course.getId(), selected);
                    }
